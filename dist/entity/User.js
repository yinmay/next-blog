...
var User = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)('varchar'), _dec5 = (0, _typeorm.CreateDateColumn)('time'), _dec6 = (0, _typeorm.UpdateDateColumn)('time'), _dec7 = (0, _typeorm.OneToMany)(function (type) {
  ...
  (0, _initializerDefineProperty2["default"])(this, "passwardDigest", _descriptor3, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "passwardDigest", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
